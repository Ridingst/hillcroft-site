  ...
  <div class="w-full lg:min-h-screen items-center bg-gray-100 grid grid-cols-1 lg:grid-cols-3 lg:gap-0">
    <div class="w-full col-span-1 lg:col-span-2 lg:inline-block px-10 z-10">
      <div class="py-6">
        ...
        <h2 class="text-2xl lg:text-4xl tracking-widest font-bold leading-snug">MEN'S.</h2>
      </div>
      <div class="py-6">
      ...
      <div class="py-6">
        <h3 class="lg:text-2xl tracking-widest font-bold leading-snug border-b border-yellow-500 pb-1 lg:w-1/4"> MEN'S 1ST TEAM.</h3>
        <p class="font-serif tracking-wider lg:tracking-widest leading-widest italic pt-6 text-gray-900">
          Our Men’s 1st Team compete at the highest level in the South of England, the SEMLA Premier Division.
          A blend of seasoned veterans and international players, they were runners-up in the 2018/19 season, narrowly missing out to Hampstead.
        </p>  
      </div>
