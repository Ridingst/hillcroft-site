  ...
  <div aria-label="footer" class="py-2">
      <div class="mx-auto container xl:px-12">
        <div class="flex flex-col md:items-center pt-3">
          <div class="my-6 text-base text-color text-gray-500">
              <ul class="md:flex items-center">
                  <li class="md:mr-6 cursor-pointer pt-4 lg:py-0"><a href="/" class="focus:outline-none focus:underline hover:text-gray-500">Home </a></li>
          ...
          <div class="text-sm text-gray-700 text-center">
            <div class="pb-4">
              ...
              <p>City of London Academy Southwark</p>
              <p>240 Lynton Rd</p>
              <p>London</p>
              <p>SE1 5LA</p>
            </div>
